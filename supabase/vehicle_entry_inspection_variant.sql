-- Modalidades de vistoria (Leve, Pesados, Tratores, Motos) — aditivo, idempotente.
...
COMMENT ON COLUMN vehicle_entry_inspections.inspection_variant IS 'LEVE | PESADOS | TRATORES | MOTOS';
COMMENT ON COLUMN vehicle_entry_inspections.form_extras IS 'Campos de texto/número da vistoria (marca, modelo, referência pneu, etc.)';
